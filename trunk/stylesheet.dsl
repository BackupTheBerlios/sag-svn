<!-- $Header: /cvsroot/ihs/ihs/doc/en.src/stylesheet.dsl,v 1.1.1.1 2005/11/01 09:44:58 paweln Exp $ -->
...
(define %html-header-tags% 
  (list 
    ...
    (list "META" '("HTTP-EQUIV" "Content-Type") '("CONTENT" "text/html; charset=ISO-8859-2") )))
